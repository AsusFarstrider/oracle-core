...
from oracle_app.interaction_synchronization import synchronized_interaction
...
@synchronized_interaction
def clear_command_interim_events_for_session(
    *, source: str | None, session_id: str | None
    ...
    if not normalized_source or not normalized_session:
        return False
    return _EVENTS.pop((normalized_source, normalized_session), None) is not None

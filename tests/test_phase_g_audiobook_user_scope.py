...
class PhaseGAudiobookUserScopeTests(unittest.TestCase):
    ...
    def test_resume_current_uses_effective_user_and_sleep_timer(self, mock_play_selected) -> None:
        canonical = Mock()
        canonical.fetch_current_progress.return_value = {"library_item_id": "book-123"}
        ...
        result = execute_audiobook(dispatch, canonical_execution=canonical)
        ...
        canonical.fetch_current_progress.assert_called_once_with(user_id="reader_two")
